 ...
 */
/**
 * Vedovatogrid comments resource collection model
 *
 * @category    Vedovato
 * @package     Vedovato_VedovatoGrid
 * @author      Ultimate Module Creator
 */
class Vedovato_VedovatoGrid_Model_Resource_Vedovatogrid_Comment_Vedovatogrid_Collection extends Vedovato_VedovatoGrid_Model_Resource_Vedovatogrid_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('vedovato_vedovatogrid/vedovatogrid_comment_store');
    }
    ...
    {
        $this->getSelect()->where('ct.vedovatogrid_id = ?', $entityId);
        return $this;
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('vedovato_vedovatogrid/vedovatogrid_comment');
        $this->getSelect()->join(
            array('ct' => $commentTable),
            'ct.vedovatogrid_id = main_table.entity_id',
            array(
                'ct_title'      => 'title',
