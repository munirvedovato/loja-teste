 ...
 */
class Vedovato_VedovatoGrid_Block_Adminhtml_Vedovatogrid_Edit_Tab_Stores extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * prepare the form
     *
     * @access protected
     * @return Vedovato_VedovatoGrid_Block_Adminhtml_Vedovatogrid_Edit_Tab_Stores
     * @author Ultimate Module Creator
     */
